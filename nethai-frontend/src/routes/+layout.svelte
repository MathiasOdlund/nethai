<script lang="ts">
	...
	// Define teams
	const teams = [
		{ title: 'Heroicons', url: '/team/heroicons', shorthand: 'H' },
		{ title: 'Tailwind Labs', url: '/team/tailwind', shorthand: 'T' },
		{ title: 'Workcation', url: '/team/workcation', shorthand: 'W' }
	];
</script>
