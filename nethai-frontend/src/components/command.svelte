...
<div class="relative z-40" role="dialog" aria-modal="true" class:hidden={!isVisible}>
	<!--
    ...
    -->
	<div
		class="fixed inset-0 bg-gray-500/25 blur-md transition-opacity"
		onclick={() => close()}
		aria-hidden="true"
	></div>

	<div class="fixed inset-0 z-40 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
		<!--
